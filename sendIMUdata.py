...
# 0.1       01-09-22   iad1046@gmail.com    modified berryIMU.py to transmit raw
#                                           sensor data over UDP socket connection
#                                           to PC running quaternion animation
################################################################################
...
## Timed rotations, rotated for ~60sec ##
## NOTE how the magXmax isn't negative anymore
...
# 10.0.0.121 = ip of win7 laptop running listener3.py
host, port = '10.0.0.121', 8090
server_address = (host, port)
print(f'Starting UDP sender on {host} port {port}')
...
while True:
    ...
    print(f'Sending  GYRx: {GYRx}, GYRy: {GYRy}, GYRz: {GYRz}')

        # Pack three 32-bit floats into message and send
    #message = pack('3f', x, y, z)
    message = pack('3i', GYRx, GYRy, GYRz)
...
'''
    ...
    #X compensation
    if(BerryIMUversion == 3):            #LSM9DS0 and (LSM6DSL & LIS2MDL)
